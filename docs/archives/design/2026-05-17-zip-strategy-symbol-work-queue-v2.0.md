...
**Version:** 2.0
**Date:** 2026-05-17
**Status:** ✅ DONE - Implemented; superseded by v3.0
**Supersedes:** `2026-05-16-zip-strategy-symbol-work-queue-v1.0.md`

> Historical note: v2.0 was implemented as the symbol-shuffle scheduler. Current runtime behavior is v3.0 dual shuffle, so v2.0 acceptance criteria below describe the implemented intermediate snapshot, not the latest scheduler semantics.
