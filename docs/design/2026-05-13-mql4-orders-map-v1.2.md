...
| Existing orders design | `docs/design/2026-05-12-orders-layer-v1.1.md` | Current `orders` architecture |
| Orders compliance review | `docs/design/2026-05-13-orders-layer-v1.1-compliance-review.md` | Implementation status before this proposal |
