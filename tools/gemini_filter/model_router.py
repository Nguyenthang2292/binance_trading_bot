...
def build_model_route(data: dict[str, Any], sentiment_model: str, vision_model: str) -> RoutedModels:
    ...
    min_score = float(vision_raw.get("pro_escalation_min_score", 0.45))
    max_score = float(vision_raw.get("pro_escalation_max_score", 0.65))
    ...
    return RoutedModels(
        ...
        vision_pro_escalation_enabled=bool(vision_raw.get("pro_escalation_enabled", False)),
